...
class RequirementsControllerTest < ActionController::TestCase
  ...
  test "should create requirement" do
    assert_difference('Requirement.count') do
      post :create, requirement: { highschool_completion_id: @requirement.highschool_completion_id, profession_id: @requirement.profession_id, study_program_id: @requirement.study_program_id }
    end
  ...
  test "should update requirement" do
    patch :update, id: @requirement, requirement: { highschool_completion_id: @requirement.highschool_completion_id, profession_id: @requirement.profession_id, study_program_id: @requirement.study_program_id }
    assert_redirected_to requirement_path(assigns(:requirement))
  end
